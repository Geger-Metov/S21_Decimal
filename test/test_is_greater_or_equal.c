...
START_TEST(test_s21_is_greater_or_equal) {
  ...
  ck_assert_int_eq(s21_is_greater_or_equal(b, a), 1);  // +54322 >= +12345

  ck_assert_int_eq(s21_is_greater_or_equal(a, b), 0);  // +12345 не >= +54322

  ck_assert_int_eq(s21_is_greater_or_equal(a, a),
                   1);  // +12345 >= +12345 (равно)
}
END_TEST
